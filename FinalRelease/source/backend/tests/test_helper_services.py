...
def test_dedupe_helpers() -> None:
    ...
    assert normalize_arxiv_id("oai:2401.00002v2") == "2401.00002"
...
def test_content_validator_flags() -> None:
    ...
    from app.service.content_validator import ValidationReport

    assert ValidationReport(flags=[]).passed is True
